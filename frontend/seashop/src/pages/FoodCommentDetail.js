...
function FoodCommentDetail() {
    ...
    useEffect(() => {
        let getComment = async () => {
            ...
            const response = await fetch(`${BASE_URL}/Settlement-api/Reply-Detail/${commentID}/`, {
...
export default FoodCommentDetail;